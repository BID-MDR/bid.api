...
@Injectable()
export class SatisfactionResearchBackofficeService extends BaseService<SatisfactionResearchEntity, any, any> {
  constructor(
  ...
  async listBeneficiaryMonth(month: number): Promise<SatisfactionResearchEntity[]>{

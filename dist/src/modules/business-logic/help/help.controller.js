...
let HelpController = HelpController_1 = class HelpController {
    helpService;
    _logger = new common_1.Logger(HelpController_1.name);
...
], HelpController.prototype, "register", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], HelpController.prototype, "GetById", null);
__decorate([
    (0, common_1.Get)(''),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_access_token_guard_1.JwtAccessTokenGuard),
    ...
    __metadata("design:returntype", Promise)
], HelpController.prototype, "list", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], HelpController.prototype, "listByUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], HelpController.prototype, "delete", null);
exports.HelpController = HelpController = HelpController_1 = __decorate([

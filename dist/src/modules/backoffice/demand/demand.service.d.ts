...
export declare class DemandBackofficeService extends BaseService<DemandEntity, DemandRegisterRequestDto, DemandRegisterRequestDto> {
    ...
    getByMonth(month: number): Promise<DemandEntity[]>;

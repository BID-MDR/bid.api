...
export declare class CompanyBackofficeService extends BaseService<CompanyEntity, any, any> {
    ...
    listByMonth(month: number): Promise<CompanyEntity[]>;
    ...
    getById(companyId: string): Promise<CompanyEntity>;
}

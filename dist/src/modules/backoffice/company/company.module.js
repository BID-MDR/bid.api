...
exports.CompanyBackofficeModule = void 0;
...
let CompanyBackofficeModule = class CompanyBackofficeModule {
};
exports.CompanyBackofficeModule = CompanyBackofficeModule;
exports.CompanyBackofficeModule = CompanyBackofficeModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, facade_module_1.FacadeModule, feature_auth_module_1.FeatureAuthModule],
        providers: [company_service_1.CompanyBackofficeService],
        controllers: [company_controller_1.CompanyBackofficeController],
    })

...
exports.HelpBackofficeModule = void 0;
...
let HelpBackofficeModule = class HelpBackofficeModule {
};
exports.HelpBackofficeModule = HelpBackofficeModule;
exports.HelpBackofficeModule = HelpBackofficeModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, facade_module_1.FacadeModule, feature_auth_module_1.FeatureAuthModule],
        providers: [help_service_1.HelpBackofficeService],
        controllers: [help_controller_1.HelpBackofficeController],
    })

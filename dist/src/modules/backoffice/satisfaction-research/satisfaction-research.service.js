...
exports.SatisfactionResearchBackofficeService = void 0;
...
let SatisfactionResearchBackofficeService = class SatisfactionResearchBackofficeService extends base_service_1.BaseService {
    ...
    async list() {
        return await this.satisfactionResearchRepository.list();
    }
    async hardDelete(id) {
        return await this.satisfactionResearchRepository.hardDelete(id);
    }
    async listBeneficiary() {
        return await this.satisfactionResearchRepository.listBeneficiary();
    }
    async listBeneficiaryMonth(month) {
        return await this.satisfactionResearchRepository.listBeneficiaryMonth(month);
    }
    async listProfessional() {
        return await this.satisfactionResearchRepository.listProfessional();
    }
    async listProfessionalMonth(month) {
        return await this.satisfactionResearchRepository.listProfessionalMonth(month);
    }
};
exports.SatisfactionResearchBackofficeService = SatisfactionResearchBackofficeService;
exports.SatisfactionResearchBackofficeService = SatisfactionResearchBackofficeService = __decorate([
...
], SatisfactionResearchBackofficeService);

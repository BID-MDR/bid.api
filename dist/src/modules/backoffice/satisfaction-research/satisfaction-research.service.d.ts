...
export declare class SatisfactionResearchBackofficeService extends BaseService<SatisfactionResearchEntity, any, any> {
    ...
    listBeneficiaryMonth(month: number): Promise<SatisfactionResearchEntity[]>;
    listProfessional(): Promise<SatisfactionResearchEntity[]>;
    listProfessionalMonth(month: number): Promise<SatisfactionResearchEntity[]>;
}

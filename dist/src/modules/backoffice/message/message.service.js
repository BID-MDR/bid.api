...
exports.MessageBackofficeService = void 0;
...
const user_repository_2 = require("../../data-interaction/database/repositories/backoffice/user/user.repository");
const message_repository_1 = require("../../data-interaction/database/repositories/backoffice/message/message.repository");
const user_backoffice_entity_1 = require("../../data-interaction/database/entitites/user-backoffice.entity");
let MessageBackofficeService = class MessageBackofficeService extends base_service_1.BaseService {
    messageRepository;
    userRepository;
    userBackofficeRepository;
    server;
    constructor(messageRepository, userRepository, userBackofficeRepository) {
    ...
    async listAllMsgByUser(userId) {
        ...
        msgList.forEach(msg => {
            [msg.sender, msg.receiver].forEach(participant => {
                if (participant instanceof user_backoffice_entity_1.UserBackofficeEntity && participant.id !== user.id) {
...
exports.MessageBackofficeService = MessageBackofficeService;
__decorate([
    (0, websockets_1.WebSocketServer)(),
    __metadata("design:type", socket_io_1.Server)
], MessageBackofficeService.prototype, "server", void 0);
exports.MessageBackofficeService = MessageBackofficeService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [message_repository_1.MessageBackofficeRepository,
        user_repository_1.UserRepository,
        user_repository_2.UserBackofficeRepository])
], MessageBackofficeService);

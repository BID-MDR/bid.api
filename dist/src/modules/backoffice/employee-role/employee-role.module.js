...
exports.EmployeeRoleBackofficeModule = void 0;
...
let EmployeeRoleBackofficeModule = class EmployeeRoleBackofficeModule {
};
exports.EmployeeRoleBackofficeModule = EmployeeRoleBackofficeModule;
exports.EmployeeRoleBackofficeModule = EmployeeRoleBackofficeModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, facade_module_1.FacadeModule, feature_auth_module_1.FeatureAuthModule],
        providers: [employee_role_service_1.EmployeeRoleBackofficeService],
        controllers: [employee_role_controller_1.EmployeeRoleBackofficeController],
    })
], EmployeeRoleBackofficeModule);

...
var EmployeeRoleBackofficeController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.EmployeeRoleBackofficeController = void 0;
...
let EmployeeRoleBackofficeController = EmployeeRoleBackofficeController_1 = class EmployeeRoleBackofficeController {
    service;
    _logger = new common_1.Logger(EmployeeRoleBackofficeController_1.name);
    constructor(service) {
...
exports.EmployeeRoleBackofficeController = EmployeeRoleBackofficeController;
__decorate([
...
], EmployeeRoleBackofficeController.prototype, "register", null);
__decorate([
    (0, common_1.Get)(''),
    (0, common_1.UseGuards)(jwt_access_token_guard_1.JwtAccessTokenGuard, roles_backoffice_guard_1.RolesBackofficeGuard),
    (0, roles_backoffice_decorator_1.Roles)([functionTypeEnum_1.FunctionTypeEnum.GERIR_AGENTE_PROMOTOR]),
    ...
    __metadata("design:returntype", Promise)
], EmployeeRoleBackofficeController.prototype, "list", null);
exports.EmployeeRoleBackofficeController = EmployeeRoleBackofficeController = EmployeeRoleBackofficeController_1 = __decorate([
    (0, common_1.Controller)("role-employee-backoffice"),
    (0, swagger_1.ApiTags)("Role-employee Backoffice"),
    __metadata("design:paramtypes", [employee_role_service_1.EmployeeRoleBackofficeService])
], EmployeeRoleBackofficeController);

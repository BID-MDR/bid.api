...
export declare class UserProfessionalInfoRepository extends BaseRepository<UserProfessionalInfoEntity, CreateUserProfessionalInfoDto, UpdateUserProfessionalInfoDto> {
    private repository;
    constructor(repository: Repository<UserProfessionalInfoEntity>);
}
